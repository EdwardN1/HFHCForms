...
class GPNF_Entry {
	...
	public function __construct( $entry ) {
		...
		//error_log('$this->_entry_id = '.$this->_entry_id);
	...
	public function set_parent_form( $parent_form_id, $parent_entry_id = false ) {
		...
		if( ! $parent_entry_id ) {
            ...
            current_new_entry_parent_id($parent_entry_id);
...
function current_new_entry_parent_id($parent_id) {
    do_action('current_new_entry_parent_id',$parent_id);
}
